...
intellisense.annotate(jQuery, {
  ...
  'data': function() {
    ...
    ///   <param name="element" type="Element">The DOM element to specification for the data.</param>
  ...
  'param': function() {
    /// <signature>
    ///   <summary>Create a serialized representation of an array or object, suitable for use in a URL specification string or Ajax request.</summary>
