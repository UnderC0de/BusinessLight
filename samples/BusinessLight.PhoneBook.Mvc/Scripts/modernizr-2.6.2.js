...
window.Modernizr = (function( window, document, undefined ) {
    ...
    tests['csstransforms3d'] = function() {
        ...
        if ( ret && 'webkitPerspective' in docElement.style ) {
          ...
          // Webkit allows this media specification to succeed only if the feature is enabled.
    ...
    /*>>mq*/
    // Modernizr.mq tests a given media specification, live against the current state of the window
    // A few important notes:
    //   * If a browser does not support media queries at all (eg. oldIE) the mq() will always return false
    //   * A max-width or orientation specification will be evaluated against the current state, which may change later.
    //   * You must specify values. Eg. If you are testing support for the min-width media specification use:
