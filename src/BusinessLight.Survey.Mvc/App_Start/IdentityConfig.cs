...
namespace BusinessLight.Survey.Mvc
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, Guid>
    {
        ...
        public static ApplicationUserManager Create(IDataProtectionProvider dataProtectionProvider, IdentityDbContext<ApplicationUser, ApplicationRole, Guid, ApplicationUserLogin, ApplicationUserRole, ApplicationUserClaim> dbContext) 
        {
